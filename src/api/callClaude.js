import { _apiSkip, _apiCallId, _lastRateLimitTime, _rateLimitCooldown, incrApiCallId, setApiSkip, setLastRateLimitTime, setRateLimitCooldown } from './apiState.js';
import { addLog } from './apiLog.js';
import { getApiHeaders } from './apiHeaders.js';

export async function callClaude(sys, user) {
